...
import DependencyCard from '../../components/dependency-card/card.vue'
import type { DependencyGroup } from './use-groups'
import type { ItemKind } from './useClassify'
...
<style scoped src="./group-section.scss" lang="scss"></style>
